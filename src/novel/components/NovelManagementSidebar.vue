...
<!-- src/novel/components/NovelManagementSidebar.vue -->
<template>
...
// 如果路由参数中没有id，则使用默认值 '1'，方便无ID时展示
const novelId = computed(() => route.params.id || '1');

const managementNav = computed(() => [
  { name: '编辑章节', path: `/novel/editor`, icon: `<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>` },
  { name: '大纲视图', path: `/novel/manage/${novelId.value}/outline`, icon: `<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 10V21M3 10L12 3L21 10M3 10H21M12 3V21M8 21V15C8 13.9 8.9 13 10 13H14C15.1 13 16 13.9 16 15V21"/></svg>` },
  { name: '角色设定', path: `/novel/manage/${novelId.value}/character-settings`, icon: `<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>` },
  { name: '世界观', path: `/novel/manage/${novelId.value}/worldview`, icon: `<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg>` },
]);

const toolsNav = computed(() => [
  { name: '小说设置', path: `/novel/manage/${novelId.value}/settings`, icon: `<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M4 21v-7M4 10V3M12 21v-9M12 8V3M20 21v-5M20 12V3M1 14h6M9 8h6M17 16h6"/></svg>` }
]);
</script>
