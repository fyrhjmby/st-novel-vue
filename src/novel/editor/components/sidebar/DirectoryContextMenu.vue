...
<template>
  ...
  >
    ...
    <!-- 设定的总览节点 (新增) -->
    <template v-else-if="node?.originalData?.isOverview">
      <p class="menu-title">总览节点</p>
      <div class="context-menu-item disabled !cursor-default !bg-transparent text-gray-400">
    ...
    <!-- "相关"中的分组或设定条目 (修改) -->
    <template v-else-if="node && !node.originalData?.isOverview">
